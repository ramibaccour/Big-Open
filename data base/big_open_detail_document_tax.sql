...
--
-- Table structure for table `detail_document_tax`
--

DROP TABLE IF EXISTS `detail_document_tax`;
...
--
-- Dumping data for table `detail_document_tax`
--

LOCK TABLES `detail_document_tax` WRITE;
/*!40000 ALTER TABLE `detail_document_tax` DISABLE KEYS */;
/*!40000 ALTER TABLE `detail_document_tax` ENABLE KEYS */;
UNLOCK TABLES;
